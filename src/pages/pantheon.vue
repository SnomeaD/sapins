                    ...
                    <div class="carousel-inner border border-dark">
                        <template v-for="(boss, index) in raid.bosses">
                            <div class="carousel-item" :class="index===0?'active':''">
                                ...
                                <div>
                                    <a class="carousel-control-center" role="button" data-toggle="modal" data-target="#zoom-screen" v-on:click="zoomScreen = imageLink(boss.screen,true)">
